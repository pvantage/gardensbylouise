...
function onDeviceReady() {
    ...
    function populateDB(tx) {
		alert('start');
		 ...
		 tx.executeSql('INSERT INTO jobs (job_id, address, description, status, contact_fname, contact_lname, contact_email, contact_phone, job_date, start_time) VALUES ("2", "Mohali, punjab, India2", "Test2", "Assigned", "Rinku2", "kamboj2", "rikamboj@fmail.com", "6456542", "2018-04-04", "13:00:00")');
