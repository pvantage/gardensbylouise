				...
				if(typeof res['data'][index]!='undefined'){
					...
					tx.executeSql(q, [res['data'][index]['ID'],uid], function(tx, rest){
						if(parseInt(rest.rows.length)>0){
							...
							tx.executeSql("UPDATE job_timesheets SET address='"+res['data'][index]['address']+"',customer_id='"+res['data'][index]['customer_id']+"',from_address='"+res['data'][index]['address_from']+"',address_to='"+res['data'][index]['address_to']+"', mileage='"+res['data'][index]['mileage']+"', end_time='"+res['data'][index]['end_time']+"', reimburse='"+res['data'][index]['reimburse']+"', lastone='"+res['data'][index]['lastone']+"', customer_name='"+res['data'][index]['customer_name']+"' WHERE id='"+fid+"' AND user_id='"+uid+"'");	
						}
						else{
